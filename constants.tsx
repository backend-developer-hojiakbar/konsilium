...
const commonStyle = { bg: 'bg-white', border: 'border-slate-200' };

export const AI_MODEL_CONFIG = {
    [AIModel.GEMINI]: { name: 'Prof. Abu Ali ibn Sino (Gemini)', Logo: GeminiLogo, text: 'text-blue-600', ...commonStyle },
    [AIModel.CLAUDE]: { name: 'Prof. Abu Rayhon Beruniy (Claude)', Logo: ClaudeLogo, text: 'text-orange-600', ...commonStyle },
    [AIModel.GPT]: { name: 'Prof. Abu Bakr ar-Roziy (GPT-4o)', Logo: GptLogo, text: 'text-teal-600', ...commonStyle },
    [AIModel.LLAMA]: { name: 'Prof. Ismoil al-Jurjoniy (Llama 3)', Logo: LlamaLogo, text: 'text-rose-600', ...commonStyle },
    [AIModel.GROK]: { name: 'Prof. Ibn al-Nafis (Grok)', Logo: GrokLogo, text: 'text-indigo-600', ...commonStyle },
    [AIModel.SYSTEM]: { name: 'Kengash Raisi (Orkestrator)', Logo: OrkestratorLogo, text: 'text-slate-600', bg: 'bg-slate-100', border: 'border-slate-300' },
};